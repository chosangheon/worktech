...
<body>
	<div class="col-md-3">
		<a href="send.mail" id="writeOrBack" class="btn btn-primary">메일 쓰기</a>
		...
		<div class="card">
			...
			<div class="card-body p-0">
				<ul class="nav nav-pills flex-column">
					...
					<li class="nav-item"><a id="sendlist-li" href="#" class="nav-link sendlist"> 
						<span onclick="location.href='${contextPath }/sendlist.mail'"> 
						<i class="far fa-paper-plane mail-icon"></i> 보낸메일함</span> 
						
						<span class="float-right">
							<button id="checkRead-btn" onclick="location.href='${contextPath}/checkReadTime.mail'" class="susin-Btn btn btn-sm btn-default">
								수신확인
							</button>
						</span>
					</a></li>
					...
					<li class="nav-item"><a href="${contextPath}/favoriteslist.mail" class="nav-link favoriteslist"> <i class="far fa-star favorites" id="favorites-icon">
						</i>즐겨찾기
					</a></li>
